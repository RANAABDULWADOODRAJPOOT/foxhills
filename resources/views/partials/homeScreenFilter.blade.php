...
<div class="row wrapper m-auto">
	<div class="p-0">
		<svg style="float: right;  margin-top: 12px;" fill="#000000" height="21" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
	...
	<div style="margin-top: 4px; justify-content: center;margin-left:34px" id="filterbarhover"  class="col-5 d-flex">
